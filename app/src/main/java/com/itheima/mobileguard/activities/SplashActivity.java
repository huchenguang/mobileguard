...
public class SplashActivity extends Activity {
                  ...
                  /*  AlertDialog.Builder builder = new Builder(SplashActivity.this);
                    ...
                    new AlertDialog.Builder(SplashActivity.this)
                            ...
                            .setOnCancelListener(new OnCancelListener() {
                                @Override
                                public void onCancel(DialogInterface dialog) {//按返回取消键也是直接进入主界面
                                    loadMainUI();
                                }
                            })
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aa.setDuration(2000);
        findViewById(R.id.rl_splash_root).startAnimation(aa);//开启动画
        ...
        new Thread() {
            public void run() {
                if (AntiVirusDao.isDBExit()) {
                    ...
                    String url = "http://192.168.1.100:8080/web/UpdateInfoServlet?version=" +
                            version;
