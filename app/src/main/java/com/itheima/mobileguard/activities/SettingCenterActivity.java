...
public class SettingCenterActivity extends Activity {
    ...
    protected void onStart() {
        //判断服务的运行状态
        boolean running = SystemInfoUtils.isServiceRunning(this, "com.itheima.mobileguard" +
                ".services.CallSmsSafeService");
        if (running) {
            sv_blacknumber.setChecked(true);
        } else {
            sv_blacknumber.setChecked(false);
        ...
        running = SystemInfoUtils.isServiceRunning(this, "com.itheima.mobileguard.services" +
                ".ShowLocationService");
        if (running) {
            sv_showaddress.setChecked(true);
        } else {
    ...
    public void changeBgStyle(View view) {
        ...
        builder.setSingleChoiceItems(items, sp.getInt("which", 0), new DialogInterface
                .OnClickListener() {
            @Override
